...
public class EditPeriodControllerTest extends ControllerTestCase {
    private EditPeriodController controller = new EditPeriodController();
    ...
    public void testFormBackingObject() throws Exception {
        ...
        verifyMocks();
        assertTrue(command instanceof EditPeriodCommand);
        assertSame(period, ((EditPeriodCommand) command).getPeriod());
    }
    ...
    public void testBindingGrid() throws Exception {
        ...
        EditPeriodCommand command
            = (EditPeriodCommand) controller.handleRequest(request, response).getModel().get("command");
