...
/**
 * This class was completely copied from Apache Felix.
 *
 */
...
public class AdminPermission extends BasicPermission {
    ...
    private Filter m_filterImpl = null;
    ...
    // admin permissions.
    private Dictionary<String, Object> m_bundleDict = null;
	...
	if (!(p instanceof AdminPermission))
        ...
        if (m_filterImpl == null)
        {
            try
            {
                m_filterImpl = FrameworkUtil.createFilter(getName());
            }
	...
	private Dictionary getBundleDictionary()
    {
        if (m_bundleDict == null)
        {
            ...
            m_bundleDict = new Hashtable<String, Object>();
    ...
    private static void createSigner(Bundle bundle, Dictionary dict)
    {
        try
        {
            Method method = bundle.getClass().getDeclaredMethod("getSignerMatcher");
            method.setAccessible(true);

            Object signer = method.invoke(bundle);
