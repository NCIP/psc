...
CREATE TABLE CSM_APPLICATION ( 
	APPLICATION_ID integer IDENTITY(0,1) NOT NULL,
...
CREATE TABLE CSM_PG_PE ( 
	PG_PE_ID integer IDENTITY(0,1) NOT NULL,
...
CREATE TABLE CSM_PRIVILEGE ( 
	PRIVILEGE_ID integer IDENTITY(0,1) NOT NULL,
...
CREATE TABLE CSM_PROTECTION_ELEMENT ( 
	PROTECTION_ELEMENT_ID integer IDENTITY(0,1) NOT NULL,
...
CREATE TABLE CSM_PROTECTION_GROUP ( 
	PROTECTION_GROUP_ID integer IDENTITY(0,1) NOT NULL,
...
CREATE TABLE CSM_ROLE_PRIVILEGE ( 
	ROLE_PRIVILEGE_ID integer IDENTITY(0,1) NOT NULL,
...
CREATE TABLE CSM_USER_GROUP ( 
	USER_GROUP_ID integer IDENTITY(0,1) NOT NULL,
...
CREATE TABLE CSM_USER_GROUP_ROLE_PG ( 
	USER_GROUP_ROLE_PG_ID integer IDENTITY(0,1) NOT NULL,
	USER_ID integer,
	GROUP_ID integer,
	ROLE_ID integer NOT NULL,
	PROTECTION_GROUP_ID integer NOT NULL,
...
CREATE TABLE CSM_USER_PE ( 
	USER_PROTECTION_ELEMENT_ID integer IDENTITY(0,1) NOT NULL,
	PROTECTION_ELEMENT_ID integer NOT NULL,
	USER_ID integer NOT NULL,
	UPDATE_DATE datetime
) 
