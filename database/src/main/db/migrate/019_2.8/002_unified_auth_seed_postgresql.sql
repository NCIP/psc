INSERT INTO csm_group(group_id, group_name, group_desc, application_id) VALUES ((select nextval('csm_group_group_id_seq')),	'system_administrator',	'Configures the technical system level properties and behavior of the applications (i.e. the password policy, email setup, ESB, etc).', (select application_id from csm_application where application_name = 'study_calendar'));

INSERT INTO csm_group(group_id, group_name, group_desc, application_id) VALUES ((select nextval('csm_group_group_id_seq')),	'business_administrator',	'Manages the domain related application wide properties and behavior (i.e. label names, reference data lists, etc)',		(select application_id from csm_application where application_name = 'study_calendar'));

INSERT INTO csm_group(group_id, group_name, group_desc, application_id) VALUES ((select nextval('csm_group_group_id_seq')),	'person_and_organization_information_manager',	'Manages organizations and rosters / Creates and updates person info including contact info, degrees/certifications, rosters they?re associated with',		(select application_id from csm_application where application_name = 'study_calendar'));

INSERT INTO csm_group(group_id, group_name, group_desc, application_id) VALUES ((select nextval('csm_group_group_id_seq')),	'data_importer',	'Identifies studies defined by Coordinating Center and imports as a consumer that data defined elsewhere',		(select application_id from csm_application where application_name = 'study_calendar'));
...
INSERT INTO csm_group(group_id, group_name, group_desc, application_id) VALUES ((select nextval('csm_group_group_id_seq')),	'study_creator',	'Creates the core study info (e.g. PI, title, description, phase, epochs/arms & basic study design, etc.) NOTE:  some sites may want to combine the supplemental study info roles into this role', 		(select application_id from csm_application where application_name = 'study_calendar'));
...
INSERT INTO csm_group(group_id, group_name, group_desc, application_id) VALUES ((select nextval('csm_group_group_id_seq')),	'study_team_administrator',	'Connects study level people to study and internal staff to study. Assigns internal staff to protocol, determines study artifact accessiblity for staff (e.g. study calendar templates, CRFs, etc.)',		(select application_id from csm_application where application_name = 'study_calendar'));

INSERT INTO csm_group(group_id, group_name, group_desc, application_id) VALUES ((select nextval('csm_group_group_id_seq')),	'study_site_participation_administrator',	'Connects participating sites to a protocol',		(select application_id from csm_application where application_name = 'study_calendar'));

INSERT INTO csm_group(group_id, group_name, group_desc, application_id) VALUES ((select nextval('csm_group_group_id_seq')), 'ae_rule_and_report_manager',	'Creates, manages, imports AE rules / Creates, manages, imports AE report definitions',		(select application_id from csm_application where application_name = 'study_calendar'));

INSERT INTO csm_group(group_id, group_name, group_desc, application_id) VALUES ((select nextval('csm_group_group_id_seq')),	'study_calendar_template_builder',	'Creates and updates study calendar templates', 		(select application_id from csm_application where application_name = 'study_calendar'));
...
INSERT INTO csm_group(group_id, group_name, group_desc, application_id) VALUES ((select nextval('csm_group_group_id_seq')), 'subject_manager',	'Defines patient to system (remaining subject data managed by other roles which are not defined)',		(select application_id from csm_application where application_name = 'study_calendar'));

INSERT INTO csm_group(group_id, group_name, group_desc, application_id) VALUES ((select nextval('csm_group_group_id_seq')),	'study_subject_calendar_manager',	'Creates and updates a subject-specific study calendar based on a study calendar template', 		(select application_id from csm_application where application_name = 'study_calendar'));

INSERT INTO csm_group(group_id, group_name, group_desc, application_id) VALUES ((select nextval('csm_group_group_id_seq')),	'registrar',	'Accepts and approves/denies subject registration requests.  Requests subject registration on a particular study',		(select application_id from csm_application where application_name = 'study_calendar'));
...
INSERT INTO csm_group(group_id, group_name, group_desc, application_id) VALUES ((select nextval('csm_group_group_id_seq')),	'ae_expedited_report_reviewer',	'Read-only: reviews, provides comments, and routes expedited reports through the review workflow',		(select application_id from csm_application where application_name = 'study_calendar'));

INSERT INTO csm_group(group_id, group_name, group_desc, application_id) VALUES ((select nextval('csm_group_group_id_seq')),	'ae_study_data_reviewer',	'Read-only: reviews, provides comments, and adverse event data through a review workflow',		(select application_id from csm_application where application_name = 'study_calendar'));

INSERT INTO csm_group(group_id, group_name, group_desc, application_id) VALUES ((select nextval('csm_group_group_id_seq')),	'lab_impact_calendar_notifier',	'Creates a calendar notification for a potential lab-based treatment modification',		(select application_id from csm_application where application_name = 'study_calendar'));

INSERT INTO csm_group(group_id, group_name, group_desc, application_id) VALUES ((select nextval('csm_group_group_id_seq')),	'lab_data_user',	'Enters, edits, and imports labs from LIMS, viewing labs, selecting and sending labs to CDMS and caAERS',		(select application_id from csm_application where application_name = 'study_calendar'));
...
INSERT INTO csm_group(group_id, group_name, group_desc, application_id) VALUES ((select nextval('csm_group_group_id_seq')), 'data_analyst',	'Read-only: searches for data, uses built-in analysis tools, exports data to third party tools',		(select application_id from csm_application where application_name = 'study_calendar'));


INSERT INTO csm_role(role_id, role_name, role_description, application_id, active_flag) VALUES ((select nextval('csm_role_role_id_seq')),	'system_administrator',	'Configures the technical system level properties and behavior of the applications (i.e. the password policy, email setup, ESB, etc).',	(select application_id from csm_application where application_name = 'study_calendar'), 1);
...
INSERT INTO csm_role(role_id, role_name, role_description, application_id, active_flag) VALUES ((select nextval('csm_role_role_id_seq')),	'study_creator',	'Creates the core study info (e.g. PI, title, description, phase, epochs/arms & basic study design, etc.) NOTE:  some sites may want to combine the supplemental study info roles into this role', 		(select application_id from csm_application where application_name = 'study_calendar'), 1);
...
INSERT INTO csm_role(role_id, role_name, role_description, application_id, active_flag) VALUES ((select nextval('csm_role_role_id_seq')),	'study_team_administrator',	'Connects study level people to study and internal staff to study. Assigns internal staff to protocol, determines study artifact accessiblity for staff (e.g. study calendar templates, CRFs, etc.)',		(select application_id from csm_application where application_name = 'study_calendar'), 1);
...
INSERT INTO csm_role(role_id, role_name, role_description, application_id, active_flag) VALUES ((select nextval('csm_role_role_id_seq')),	'study_site_participation_administrator',	'Connects participating sites to a protocol',		(select application_id from csm_application where application_name = 'study_calendar'), 1);
...
INSERT INTO csm_role(role_id, role_name, role_description, application_id, active_flag) VALUES ((select nextval('csm_role_role_id_seq')),  'ae_rule_and_report_manager',	'Creates, manages, imports AE rules / Creates, manages, imports AE report definitions',		(select application_id from csm_application where application_name = 'study_calendar'), 1);
...
INSERT INTO csm_role(role_id, role_name, role_description, application_id, active_flag) VALUES ((select nextval('csm_role_role_id_seq')),	'study_calendar_template_builder',	'Creates and updates study calendar templates', 		(select application_id from csm_application where application_name = 'study_calendar'), 1);
...
INSERT INTO csm_role(role_id, role_name, role_description, application_id, active_flag) VALUES ((select nextval('csm_role_role_id_seq')), 'subject_manager',	'Defines patient to system (remaining subject data managed by other roles which are not defined)',		(select application_id from csm_application where application_name = 'study_calendar'), 1);
...
INSERT INTO csm_role(role_id, role_name, role_description, application_id, active_flag) VALUES ((select nextval('csm_role_role_id_seq')),	'study_subject_calendar_manager',	'Creates and updates a subject-specific study calendar based on a study calendar template', 		(select application_id from csm_application where application_name = 'study_calendar'), 1);
...
INSERT INTO csm_role(role_id, role_name, role_description, application_id, active_flag) VALUES ((select nextval('csm_role_role_id_seq')),	'registrar',	'Accepts and approves/denies subject registration requests. Requests subject registration on a particular study',		(select application_id from csm_application where application_name = 'study_calendar'), 1);
...
INSERT INTO csm_role(role_id, role_name, role_description, application_id, active_flag) VALUES ((select nextval('csm_role_role_id_seq')),	'ae_expedited_report_reviewer',	'Read-only: reviews, provides comments, and routes expedited reports through the review workflow',		(select application_id from csm_application where application_name = 'study_calendar'), 1);
...
INSERT INTO csm_role(role_id, role_name, role_description, application_id, active_flag) VALUES ((select nextval('csm_role_role_id_seq')),	'ae_study_data_reviewer',	'Read-only: reviews, provides comments, and adverse event data through a review workflow',		(select application_id from csm_application where application_name = 'study_calendar'), 1);
...
INSERT INTO csm_role(role_id, role_name, role_description, application_id, active_flag) VALUES ((select nextval('csm_role_role_id_seq')), 'data_analyst',	'Read-only: searches for data, uses built-in analysis tools, exports data to third party tools',		(select application_id from csm_application where application_name = 'study_calendar'), 1);
