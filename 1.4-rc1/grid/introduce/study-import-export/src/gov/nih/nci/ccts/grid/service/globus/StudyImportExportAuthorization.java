 ...
 * 
 */
public class StudyImportExportAuthorization{
	
	
	public StudyImportExportAuthorization() {
	}
	...
	public static void authorizeExportStudyByCoordinatingCenterIdentifier() throws RemoteException {
