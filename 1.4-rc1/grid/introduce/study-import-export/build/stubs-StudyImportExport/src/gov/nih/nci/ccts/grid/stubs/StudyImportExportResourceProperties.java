/**
 * StudyImportExportResourceProperties.java
 *
...
public class StudyImportExportResourceProperties  implements java.io.Serializable {
    private gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata;

    public StudyImportExportResourceProperties() {
    }
    ...
    /**
     * Gets the serviceMetadata value for this StudyImportExportResourceProperties.
     * 
    ...
    /**
     * Sets the serviceMetadata value for this StudyImportExportResourceProperties.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof StudyImportExportResourceProperties)) return false;
        StudyImportExportResourceProperties other = (StudyImportExportResourceProperties) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(StudyImportExportResourceProperties.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://grid.ccts.nci.nih.gov/StudyImportExport", ">StudyImportExportResourceProperties"));
