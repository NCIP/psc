/**
 * StudyServiceReference.java
 *
 * This file was auto-generated from WSDL
 * by the Apache Axis 1.2RC2 Apr 28, 2006 (12:42:00 EDT) WSDL2Java emitter.
 */

package edu.northwestern.bioinformatics.studycalendar.grid.stubs.types;

public class StudyServiceReference  implements java.io.Serializable {
    private org.apache.axis.message.addressing.EndpointReferenceType endpointReference;

    public StudyServiceReference() {
    }
    ...
    /**
     * Gets the endpointReference value for this StudyServiceReference.
     * 
    ...
    /**
     * Sets the endpointReference value for this StudyServiceReference.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof StudyServiceReference)) return false;
        StudyServiceReference other = (StudyServiceReference) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(StudyServiceReference.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://grid.studycalendar.bioinformatics.northwestern.edu/StudyService/types", ">StudyServiceReference"));
