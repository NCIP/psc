/**
 * StudyServiceResourceProperties.java
 *
...
public class StudyServiceResourceProperties  implements java.io.Serializable {
    private gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata;

    public StudyServiceResourceProperties() {
    }
    ...
    /**
     * Gets the serviceMetadata value for this StudyServiceResourceProperties.
     * 
    ...
    /**
     * Sets the serviceMetadata value for this StudyServiceResourceProperties.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof StudyServiceResourceProperties)) return false;
        StudyServiceResourceProperties other = (StudyServiceResourceProperties) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(StudyServiceResourceProperties.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://grid.studycalendar.bioinformatics.northwestern.edu/StudyService", ">StudyServiceResourceProperties"));
