/**
 * StudyImportExportPortTypeSOAPBindingStub.java
 *
 * This file was auto-generated from WSDL
 * by the Apache Axis 1.2RC2 Apr 28, 2006 (12:42:00 EDT) WSDL2Java emitter.
 */

package gov.nih.nci.ccts.grid.stubs.bindings;

public class StudyImportExportPortTypeSOAPBindingStub extends org.apache.axis.client.Stub implements gov.nih.nci.ccts.grid.stubs.StudyImportExportPortType {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("exportStudyByCoordinatingCenterIdentifier");
        oper.addParameter(new javax.xml.namespace.QName("http://grid.ccts.nci.nih.gov/StudyImportExport", "ExportStudyByCoordinatingCenterIdentifierRequest"), new javax.xml.namespace.QName("http://grid.ccts.nci.nih.gov/StudyImportExport", ">ExportStudyByCoordinatingCenterIdentifierRequest"), gov.nih.nci.ccts.grid.stubs.ExportStudyByCoordinatingCenterIdentifierRequest.class, org.apache.axis.description.ParameterDesc.IN, false, false);
        oper.setReturnType(new javax.xml.namespace.QName("http://grid.ccts.nci.nih.gov/StudyImportExport", ">ExportStudyByCoordinatingCenterIdentifierResponse"));
        oper.setReturnClass(gov.nih.nci.ccts.grid.stubs.ExportStudyByCoordinatingCenterIdentifierResponse.class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://grid.ccts.nci.nih.gov/StudyImportExport", "ExportStudyByCoordinatingCenterIdentifierResponse"));
    ...
    public StudyImportExportPortTypeSOAPBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public StudyImportExportPortTypeSOAPBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public StudyImportExportPortTypeSOAPBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
            ...
            qName = new javax.xml.namespace.QName("http://grid.ccts.nci.nih.gov/StudyImportExport", ">ExportStudyByCoordinatingCenterIdentifierResponse");
            cachedSerQNames.add(qName);
            cls = gov.nih.nci.ccts.grid.stubs.ExportStudyByCoordinatingCenterIdentifierResponse.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://grid.ccts.nci.nih.gov/StudyImportExport", ">StudyImportExportResourceProperties");
            cachedSerQNames.add(qName);
            cls = gov.nih.nci.ccts.grid.stubs.StudyImportExportResourceProperties.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://grid.ccts.nci.nih.gov/StudyImportExport/types", ">StudyImportExportReference");
            cachedSerQNames.add(qName);
            cls = gov.nih.nci.ccts.grid.stubs.types.StudyImportExportReference.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://grid.ccts.nci.nih.gov/StudyImportExport", ">ExportStudyByCoordinatingCenterIdentifierRequest");
            cachedSerQNames.add(qName);
            cls = gov.nih.nci.ccts.grid.stubs.ExportStudyByCoordinatingCenterIdentifierRequest.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
    ...
    public gov.nih.nci.ccts.grid.stubs.ExportStudyByCoordinatingCenterIdentifierResponse exportStudyByCoordinatingCenterIdentifier(gov.nih.nci.ccts.grid.stubs.ExportStudyByCoordinatingCenterIdentifierRequest parameters) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
        ...
        _call.setSOAPActionURI("http://grid.ccts.nci.nih.gov/StudyImportExport/ExportStudyByCoordinatingCenterIdentifierRequest");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("", "exportStudyByCoordinatingCenterIdentifier"));
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (gov.nih.nci.ccts.grid.stubs.ExportStudyByCoordinatingCenterIdentifierResponse) _resp;
            } catch (java.lang.Exception _exception) {
                return (gov.nih.nci.ccts.grid.stubs.ExportStudyByCoordinatingCenterIdentifierResponse) org.apache.axis.utils.JavaUtils.convert(_resp, gov.nih.nci.ccts.grid.stubs.ExportStudyByCoordinatingCenterIdentifierResponse.class);
            }
        }
    }
