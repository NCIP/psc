...
<html>
    ...
    <body>
        <h1>Arm ${arm.name} for Study ${arm.epoch.plannedCalendar.study.name}</h1>
        <h2>Periods</h2>
        ...
        <a href="<c:url value="/pages/calendarTemplate?id=${arm.epoch.plannedCalendar.study.id}"/>">View Template for ${arm.epoch.plannedCalendar.study.name}</a><br/>
  </body>
</html>