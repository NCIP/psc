/**
 * StudyImportExportReference.java
 *
...
public class StudyImportExportReference  implements java.io.Serializable {
    private org.apache.axis.message.addressing.EndpointReferenceType endpointReference;

    public StudyImportExportReference() {
    }
    ...
    /**
     * Gets the endpointReference value for this StudyImportExportReference.
     * 
    ...
    /**
     * Sets the endpointReference value for this StudyImportExportReference.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof StudyImportExportReference)) return false;
        StudyImportExportReference other = (StudyImportExportReference) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(StudyImportExportReference.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://grid.ccts.nci.nih.gov/StudyImportExport/types", ">StudyImportExportReference"));
