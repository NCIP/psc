...
public class ParticipantCoordinatorController extends SimpleFormController {
    ...
    protected Map<String, Object> referenceData(HttpServletRequest httpServletRequest) throws Exception {
        ...
        HashMap<String, List> userLists = StudyCalendarAuthorizationManager.getUsers(GROUP_NAME, study.getClass().getName()+"."+study.getId());
    ...
    protected ModelAndView onSubmit(HttpServletRequest request, HttpServletResponse response, Object oCommand, BindException errors) throws Exception {
        ...
        StudyCalendarAuthorizationManager.assignProtectionElementsToUsers((ArrayList)assignCommand.getAssignedCoordinators(), assignedStudy.getClass().getName()+"."+assignedStudy.getId());
