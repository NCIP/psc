...
public class ReportBuilderSelectSitesControllerTest extends ControllerTestCase {
	...
	public void testHandleRequest() throws Exception {
        ...
        SecurityContextHolderTestHelper.setSecurityContext("joe", null);

        expect(userDao.getByName(user.getName())).andReturn(user);
        expect(templateService.filterForVisibility((List) notNull(), eq(user.getUserRole(Role.SUBJECT_COORDINATOR)))).andReturn(studiesBySites);
