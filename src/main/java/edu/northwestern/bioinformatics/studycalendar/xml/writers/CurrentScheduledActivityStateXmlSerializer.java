 ...
 * @author John Dzak
 */
public class CurrentScheduledActivityStateXmlSerializer extends AbstractStudyCalendarXmlSerializer<ScheduledActivityState> {
    ...
    public Element createElement(ScheduledActivityState state) {
        Element elt = CURRENT_SCHEDULED_ACTIVITY_STATE.create();
