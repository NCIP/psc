 ...
 * @author John Dzak
 */
public abstract class AbstractAssignParticipantCoordinatorCommand<R extends Named, C extends Named> extends AbstractGridCommand<R, C> {
    private List<Study> assignableStudies;
    private List<Site> assignableSites;
    private List<User> assignableUsers;

    protected AbstractAssignParticipantCoordinatorCommand(List<Study> assignableStudies, List<Site> assignableSites, List<User> assignableUsers) {
