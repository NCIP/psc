 ...
 *     from bookmarks or by typing the URLs), hotlinks from one to the
 ...
 *     a link to an already-open application tab will not result in the 
 *     target tab coming to the front.  This happens in both Firefox 2 and 
 *     IE7 -- it appears to be by design.
 *
