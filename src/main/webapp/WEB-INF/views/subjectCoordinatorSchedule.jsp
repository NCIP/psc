...
<head>
    ...
    <script type="text/javascript">
        ...
        function ajaxform() {
            var href = '<c:url value="/pages/dashboard/subjectCoordinatorSchedule"/>'
                ...
                <li class="day autoclear ${commons:parity(status.index)}">
                    ...
                    <c:forEach items="${study.studySites}" var="studySites" varStatus="studySiteStatus">
                        ...
                        <li class="noMargin ">
                             ...
                             <ul class="controls">
                                <tags:restrictedListItem cssClass="control" url="/pages/cal/assignSubject" queryString="id=${study.id}&siteId=${studySites.site.id}">Assign subject</tags:restrictedListItem>
                            </ul>
